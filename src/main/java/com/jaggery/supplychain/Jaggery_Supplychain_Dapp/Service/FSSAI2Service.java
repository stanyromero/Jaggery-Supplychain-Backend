...
public class FSSAI2Service {
    ...
    public FSSAI2Service(
            @Qualifier("web3jFSSAI2") Web3j web3j,
            @Qualifier("fssai2Credentials") Credentials credentials,
    ...
    public String verifyBatch(InspectionDataByFSSAI2 data) throws Exception {
        ...
        TransactionReceipt receipt = contract.uploadInspectionByFSSAI2(
                uuidBytes,
                data.getInspectorId(),
